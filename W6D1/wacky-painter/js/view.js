...
View.prototype.exercise3 = function () {
  ...
  // document.getElementById('easel').append("<h1>i love jquery</h1>"); //doesn't quite work
};
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $('li.square:nth-of-type(2n)').text('Alexander');
};
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  // $.each($('li'), (square) => {
  //   square.attr('style', "background-color: " + window._randomColorString());
  // });
  $('li.square').each((idx, square) => {

...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    (0, _api_util2.default)(searchTerm).then(function (giphys) {
...
var GiphysIndexItem = function GiphysIndexItem(_ref) {
  ...
  return React.createElement(
    "li",
    { className: "giphy-li" },
    React.createElement("img", { src: giphy.images.fixed_height.url })
  );
};
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { onChange: this.handleUpdate, type: 'text', value: '' }),
          _react2.default.createElement(
            'button',
